...
data = [
    ...
    {"name": "Bread (White/Whole Dempsters) 675 G", "price": 2.22, "category": "Pantry Staples", "store": "Freshco"},
    {"name": "Bread (Whole Grain Dempsters) 600 G", "price": 2.98, "category": "Pantry Staples", "store": "Food Basics"},
    {"name": "Pasta (Penne Primo) 900 G", "price": 2.50, "category": "Pantry Staples", "store": "Metro"},
    {"name": "Rice (Jasmine) 8 KG", "price": 13.99, "category": "Pantry Staples", "store": "No Frills"},
    ...
    {"name": "Mayonnaise (Hellman) 890 ML", "price": 5.77, "category": "Pantry Staples", "store": "Walmart"},
    {"name": "Mustard (Great Value) 890 ML", "price": 1.27, "category": "Pantry Staples", "store": "Walmart"},
    {"name": "Ketchup (No Name) 1 L", "price": 3.29, "category": "Pantry Staples", "store": "No Frills"},

    {"name": "Sunflower Oil (Unico) 3 L", "price": 9.99, "category": "Pantry Staples", "store": "Highland Farms"},
    {"name": "Flour (All Purpose No Name) 2.5 KG", "price": 4.49, "category": "Pantry Staples", "store": "Loblaws"},
